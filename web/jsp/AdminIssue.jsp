...
--%>
<%@page import="it.webapp.view.AdminIssueBaseView"%>
<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
<%@page import="it.webapp.applicationcontroller.AdminIssueController"%>
<%@page import="it.webapp.requestprocessor.AdminIssuePreprocessor"%>
...
<html>
    <head>
        ...
        <title>Valuta segnalazioni | Nanobit</title>
    ...
    $(function () {
        window.pagObj = $('#pagination').twbsPagination({
            ...
            onPageClick: function (event, page) {
                ...
                var data = {
                    ${AdminIssuePreprocessor.OFFSET_PARAM}: offset,
                    ${AdminIssuePreprocessor.COUNT_PARAM}: count
                };
                
                //Performs ajax request
                $.post("${contextPath}${AdminIssueController.URL}", data, function(result){
