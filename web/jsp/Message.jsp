...
<%@page import="it.webapp.view.MessageView" %>
<%@page import="it.webapp.applicationcontroller.HomepageController" %>

<c:set var="contextPath" value="${pageContext.request.contextPath}"></c:set>
<c:set var="messageTitle" value="<%= (String) request.getAttribute(MessageView.TITLE_ATTRIBUTE) %>"></c:set>
<c:set var="messageDescription" value="<%= (String) request.getAttribute(MessageView.DESCRIPTION_ATTRIBUTE) %>"></c:set>
            ...
            <div class="content">
                <div class="error-box">
                    <div>
                        ...
                        <p class="text-small">${messageDescription}</p>
                    </div>
                </div>
