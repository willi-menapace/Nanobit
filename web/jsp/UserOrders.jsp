<%--
    ...
    Desciption  : Pagina utilizzata dall'utente per visualizzare i propri oridini
...
<%@page import="it.webapp.applicationcontroller.UserOrdersController"%>
<%@page import="it.webapp.requestprocessor.UserOrdersPreprocessor"%>
    ...
    $(function () {
        window.pagObj = $('#pagination').twbsPagination({
            ...
            onPageClick: function (event, page) {
                ...
                var data = {
                    ${UserOrdersPreprocessor.OFFSET_PARAM}: offset,
                    ${UserOrdersPreprocessor.COUNT_PARAM}: count
                };
                
                //Performs ajax request
                $.post("${contextPath}${UserOrdersController.URL}", data, function(result){
