<%--
    ...
    Desciption  : Pagina utilizzata per visualizzare le notifiche
...
<%@page import="it.webapp.applicationcontroller.NotificationController"%>
<%@page import="it.webapp.requestprocessor.NotificationPreprocessor"%>
...
<html>
    <head>
        ...
        <title>Le tue notifiche | Nanobit</title>
        ...
        <link rel="stylesheet" type="text/css" href="${contextPath}/css/Notification.css">
    </head>
    <body>
        <div class="container">
    ...
    $(function () {
        window.pagObj = $('#pagination').twbsPagination({
            ...
            onPageClick: function (event, page) {
                ...
                var data = {
                    ${NotificationPreprocessor.OFFSET_PARAM}: offset,
                    ${NotificationPreprocessor.COUNT_PARAM}: count
                };
                
                //Performs ajax request
                $.post("${contextPath}${NotificationController.URL}", data, function(result){
