...
/**
 * Preprocesses a request for a form to close an Issue
 */
public class AddIssueEvaluationFormPreprocessor implements RequestPreprocessor {

	public static final String ISSUE_ID_PARAM = "add_issue_evaluation_form_preprocessor_issue_id";
	
	public static final String ISSUE_ID_ATTRIBUTE = "add_issue_evaluation_form_preprocessor_issue_id";
