...
/**
 * Preprocesses a request to open a new issue
 */
public class AddIssuePreprocessor implements RequestPreprocessor {

	public static final String SHOP_ORDER_ITEM_ID_PARAM = "add_issue_shop_order_item_id";
	public static final String DESCRIPTION_PARAM = "add_issue_description";
	
	public static final String USER_ID_ATTRIBUTE = "add_issue_shop_order_user_id";
	public static final String SHOP_ORDER_ITEM_ID_ATTRIBUTE = "add_issue_shop_order_item_id";
	public static final String DESCRIPTION_ATTRIBUTE = "add_issue_description";
	
	private JdbcShopOrderDao shopOrderDao;
	private JdbcShopOrderItemDao shopOrderItemDao;
	
	public AddIssuePreprocessor() throws RequestPreprocessorException {
		try {
	...
	public boolean checkAuthorization(HttpServletRequest request) {
		...
		try {
			...
			//It was the same user that placed the order
