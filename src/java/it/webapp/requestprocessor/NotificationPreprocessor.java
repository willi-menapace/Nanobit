...
/**
 * Preprocessor for a request of notification for a given user
 */
public class NotificationPreprocessor implements RequestPreprocessor {

	public static final String OFFSET_PARAM = "notification_preprocessor_offset";
	public static final String COUNT_PARAM = "notification_preprocessor_count";
	
	public static final String USER_ID_ATTRIBUTE = "notification_preprocessor_user_id";
	public static final String OFFSET_ATTRIBUTE = "notification_preprocessor_offset";
	public static final String COUNT_ATTRIBUTE = "notification_preprocessor_count";
