...
/**
 * Sends a registration confirmation page as response
 */
public class AddUserSuccessfulView implements View {

    private static final String PAGE_URL = "/jsp/AddUserSuccessful.jsp";
