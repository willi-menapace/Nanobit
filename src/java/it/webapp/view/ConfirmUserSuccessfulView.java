...
/**
 * Sends a user account confirmation success message as response
 */
public class ConfirmUserSuccessfulView implements View {
    
    private static final String PAGE_URL = "/jsp/ConfirmUserSuccessful.jsp";
