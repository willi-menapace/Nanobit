...
public class UpdateShopView implements View{

	private static final String PAGE_URL = "/jsp/UpdateShop.jsp";
	
	public static final String MESSAGE_ATTRIBUTE = "update_shop_view_message";
	...
	public static final void setRequestParameters(String message, HttpServletRequest request) {
		...
		request.setAttribute(UpdateShopView.MESSAGE_ATTRIBUTE, message);
	}
