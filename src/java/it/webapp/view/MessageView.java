...
public class MessageView implements View {
    ...
    public static final String TITLE_ATTRIBUTE = "message_view_title";
    public static final String DESCRIPTION_ATTRIBUTE = "message_view_description";
    private static final String PAGE_URL = "/jsp/Message.jsp";
