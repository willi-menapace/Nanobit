...
import it.webapp.applicationcontroller.UpdateOrderStatusFormController;
 ...
 */
public class ShopOrdersView implements View {

	public static final String SHOP_ORDERS_ATTRIBUTE = "shop_orders_view_shop_orders";
	...
	public void view(HttpServletRequest request, HttpServletResponse response) {
		...
		for(ShopOrderAggregateInfo currentOrderAggregate : shopOrdersAggregate) {
			...
			writer.write("</div>");
                        ...
                        writer.write("<div class=\"link-buttons-container\">");
                            writer.write("<div class=\"info-noborder\">");
                            ...
                            writer.write("<div class=\"info-noborder\">");
                            writer.write("<a class=\"border-link-button\" href=\"" + request.getContextPath() + UpdateOrderStatusFormController.URL + "?" + UpdateOrderStatusFormPreprocessor.SHOP_ORDER_ID_PARAM + "=" + shopOrder.getShopOrderId() + "\">Aggiorna stato ordine</a>");
                            writer.write("</div>");
                        writer.write("</div>");
