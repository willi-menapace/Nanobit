...
/**
 * Sends a successful Shop registration message
 */
public class AddShopSuccessfulView implements View {
    
    private static final String PAGE_URL = "/jsp/AddShopSuccessful.jsp";
