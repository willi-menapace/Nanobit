...
/**
 * Sends a user account confirmation error as response
 */
public class ConfirmUserErrorView implements View {

	public static final String MESSAGE_ATTRIBUTE = "confirm_user_error_message";
    private static final String PAGE_URL = "/jsp/ConfirmUserError.jsp";
